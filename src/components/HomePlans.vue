    ...
    <v-layout row wrap>
      <v-flex xs12 sm12 md4>
        <v-hover v-slot:default="{ hover }">
          <v-card>
            <v-img src="https://picsum.photos/id/1019/700/800" height="500px">
              <v-container fill-height fluid>
                <v-layout fill-height>
                  <v-flex xs12 align-end flexbox>
                    <span class="headline white--text">PRJ1</span>
                  </v-flex>
                </v-layout>
              </v-container>
            </v-img>
      ...
      <v-flex xs12 sm12 md4>
        <v-card>
          <v-img src="https://picsum.photos/id/1018/700/800" height="500px">
            <v-container fill-height fluid>
              <v-layout fill-height>
                <v-flex xs12 align-end flexbox>
                  <span class="headline white--text">PRJ2</span>
                </v-flex>
              </v-layout>
            </v-container>
          </v-img>
      ...
      <v-flex xs12 sm12 md4>
        <v-card>
          <v-img src="https://picsum.photos/id/1022/700/800" height="500px">
            <v-container fill-height fluid>
              <v-layout fill-height>
                <v-flex xs12 align-end flexbox>
                  <span class="headline white--text">PRJ3</span>
                </v-flex>
              </v-layout>
            </v-container>
          </v-img>
